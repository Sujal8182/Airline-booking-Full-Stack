...
exports.searchFlights = async (req,res)=>{
  ...
  if(from === to){
    return res.status(400).json({ message : "From and to airport cannot be same"})
  }
  ...
  const seatField = cabinclass === "economy" ? "seatsAvailable.economy" : "seatsAvailable.business"
